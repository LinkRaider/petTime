...
import { Pet, PetStats } from '../../../src/types';
      ...
      <View style={styles.header}>
        <View style={styles.petInfo}>
          ...
          <Text style={styles.petBreed}>
            {pet.breed || pet.pet_type?.name}
          </Text>
        </View>
        <View
          style={[
            styles.moodBadge,
            { backgroundColor: getMoodColor(pet.mood) },
          ]}
        >
          <Text style={styles.moodEmoji}>{getMoodEmoji(pet.mood)}</Text>
          <Text style={styles.moodText}>{pet.mood}</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.levelContainer}>
          <View style={styles.levelBadge}>
            <Text style={styles.levelNumber}>{pet.level}</Text>
            <Text style={styles.levelLabel}>Level</Text>
          </View>
          <View style={styles.xpInfo}>
            <Text style={styles.xpText}>{pet.total_xp} XP</Text>
            {stats && (
              <>
